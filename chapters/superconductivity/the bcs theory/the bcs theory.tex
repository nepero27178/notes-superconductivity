...
%
%\begin{cit}{goodstein2014states}{5.3.d}
%	If $\Delta_0$ were the binding energy per electron in the pairing process, we would expect the energy of the superconducting ground state to be lower than the normal ground state by $N\Delta_0$. Instead the difference in energy
%\end{cit}
