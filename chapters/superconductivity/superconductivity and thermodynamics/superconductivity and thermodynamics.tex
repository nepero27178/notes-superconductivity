...
\begin{figure}
    \centering
    \input{chapters/superconductivity/superconductivity and thermodynamics/pictures/perfect conductors and thermodynamics}
...
\begin{figure}
    \centering
    \input{chapters/superconductivity/superconductivity and thermodynamics/pictures/critical region}
...
\begin{figure}
    \centering
    \input{chapters/superconductivity/superconductivity and thermodynamics/pictures/critical region first order}
...
\begin{figure}
    \centering
    \input{chapters/superconductivity/superconductivity and thermodynamics/pictures/first order transition entropy}
...
\begin{figure}
    \centering
    \input{chapters/superconductivity/superconductivity and thermodynamics/pictures/critical region second order}
...
\begin{figure}
    \centering
    \input{chapters/superconductivity/superconductivity and thermodynamics/pictures/second order transition specific heat}
